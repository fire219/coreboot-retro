...
unsigned long write_pirq_routing_table(unsigned long addr)
{
	...
	write_pirq_info(pirq_info, 0, PCI_DEVFN(0x08, 0),
			0x61, 0xdeb8, 0x62, 0xdeb8, 0x63, 0xdeb8, 0x60, 0xdeb8, 5, 0);
	pirq_info++;
	slot_num++;

	/* pci slot 6 (this does not exist???) */
	write_pirq_info(pirq_info, 0, PCI_DEVFN(0x0d, 0),
			0x62, 0xdeb8, 0x63, 0xdeb8, 0x60, 0xdeb8, 0x61, 0xdeb8, 6, 0);
	pirq_info++;
	slot_num++;
